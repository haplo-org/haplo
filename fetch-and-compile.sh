...
MAXMIND_DB_VERSION=20191015
MAXMIND_DB_DIGEST=fedb49848bad604fd0a91cb6156336d781334abe
...
mvn package
cp target/haplo-3.20191016.1025.22f13f55f3.jar framework/haplo.jar
