...
import com.oneis.appserver.*;
import com.oneis.utils.LimitedFilterOutputStream;
...
public class RequestHandler extends AbstractHandler {
    ...
    private static final String HEALTH_URL = "/-health/"+System.getProperty("com.oneis.healthurl");
    ...
    public RequestHandler(Framework framework, boolean inDevelopmentMode) {
        ...
        this.logger = Logger.getLogger("com.oneis.http");
    }
    ...
    public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse servletResponse) throws IOException, ServletException {
        ...
        try {
            ...
            Logger.getLogger("com.oneis.app").error(logMessage);
        }
    }
        ...
        if(response == null && request.getMethod().equals("POST")) {
            ...
            if(fileUploads != null) {
                ...
                if(r.getContentLength() != 0) {
                    ...
                    String header = r.getFirstHeader("X-ONEIS-Reportable-Error");
                    ...
                    try {
                        ...
                        Logger.getLogger("com.oneis.app").error("While handling " + target + ", got UserReportableFileUploadException: " + e.getMessage());
                    }
                }
            }
        }
    ...
    private Response handleHealthRequest(Request baseRequest, HttpServletRequest request) {
        ...
        if(errors != null) {
            Logger.getLogger("com.oneis.app").error("HEALTH CHECK FAILED: " + errors);
        }
