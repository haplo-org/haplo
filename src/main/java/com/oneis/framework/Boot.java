...
import com.oneis.common.utils.SSLCertificates;
import com.oneis.common.utils.SSLCipherSuites;

import com.oneis.utils.ProcessStartupFlag;

import com.oneis.appserver.Scheduler;
...
public class Boot {
    ...
    // Port positions in the com.oneis.listen property
    ...
    private void boot(String[] args) throws Exception {
        ...
        com.oneis.javascript.Runtime.initializeSharedEnvironment(rootDir);
        ...
        if(envName.equals("production")) {
            ...
            Appender appender = Logger.getLogger("com.oneis").getAppender("ERRORS");
            if(appender != null) {
        ...
        logger.info("JavaScript initialisation took " + com.oneis.javascript.Runtime.initializeSharedEnvironmentTimeTaken + "ms");
    ...
    public static int[] getConfiguredListeningPorts(String envName) {
        String configuredPortsProperty = System.getProperty("com.oneis.listen."+envName, System.getProperty("com.oneis.listen"));
        if(configuredPortsProperty == null || !(Pattern.matches("\\A\\d+,\\d+,\\d+,\\d+\\z", configuredPortsProperty))) {
            throw new RuntimeException("No com.oneis.listen property defined or invalid string specified");
        }
