...
public class ThumbnailFinder extends Operation {
    ...
    private ThumbnailSize.Dimensions tryImageFormat(InputStream input, String outFilename, String outFormat, int maxDimension) {
        try {
            ...
            // com.oneis.graphics.Thumbnail required for disambiguating against POI Thumbnail class
            return com.oneis.graphics.Thumbnail.scaleAndOutputRenderedImage(sourceImage, outFilename, outFormat, maxDimension);
        } catch(Exception e) {
