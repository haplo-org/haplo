...
class KDateTimeTest < Test::Unit::TestCase
  ...
  def test_kdatetime3
    ...
    assert_equal ['2011-01-01 00:00:00', '2012-01-01 00:00:00'], d1.__test_range_value
    assert_equal Time.new(2011, 7, 2, 12, 0), d1.midpoint_datetime
    assert_equal Time.new(2011, 1, 1, 0, 0), d1.start_datetime
    ...
    assert_equal ['2011-12-27 00:00:00', '2011-12-28 00:00:00'], d2.__test_range_value
    assert_equal Time.new(2011, 12, 27, 12, 0), d2.midpoint_datetime

    d3 = KDateTime.new(Time.new(2011, 10, 19, 21, 24)) # Time
    assert_equal 'm', d3.precision
    assert_equal ['2011 10 19 21 24', '', 'm', ''], d3.keditor_values
    assert_equal '19 Oct 2011, 21:24', d3.to_s
    assert_equal ['2011-10-19 21:24:00', '2011-10-19 21:25:00'], d3.__test_range_value
    assert_equal Time.new(2011, 10, 19, 21, 24, 30), d3.midpoint_datetime # includes 30 secs
    ...
    assert_equal ['2010-11-09 00:00:00', '2010-11-10 00:00:00'], d3b.__test_range_value
    assert_equal Time.new(2010, 11, 9, 12, 0), d3b.midpoint_datetime
    ...
    assert_equal ['2011-09-12 14:23:00', '2011-09-12 14:24:00'], d4.__test_range_value
    assert_equal Time.new(2011, 9, 12, 14, 23, 30), d4.midpoint_datetime

    # Check truncation
    d5 = KDateTime.new(Time.new(2011, 10, 20, 21, 24), nil, 'd')
    assert_equal 'd', d5.precision
    assert_equal ['2011 10 20', '', 'd', ''], d5.keditor_values
    assert_equal '20 Oct 2011', d5.to_s
    assert_equal ['2011-10-20 00:00:00', '2011-10-21 00:00:00'], d5.__test_range_value
    assert_equal Time.new(2011, 10, 20, 12, 00), d5.midpoint_datetime
    d6 = KDateTime.new("2011", nil, 'D')
    assert_equal ['2010', '', 'D', ''], d6.keditor_values
    assert_equal '2010s', d6.to_s
    assert_equal ['2010-01-01 00:00:00', '2020-01-01 00:00:00'], d6.__test_range_value
    assert_equal Time.new(2015, 1, 1, 0, 0), d6.midpoint_datetime
    d7 = KDateTime.new("1986", nil, 'C')
    assert_equal ['1900', '', 'C', ''], d7.keditor_values
    assert_equal '1900c', d7.to_s
    assert_equal ['1900-01-01 00:00:00', '2000-01-01 00:00:00'], d7.__test_range_value
    assert_equal Time.new(1950, 1, 1, 0, 0), d7.midpoint_datetime
    d8 = KDateTime.new("2019 10 23", nil, 'Y')
    assert_equal ['2019', '', 'Y', ''], d8.keditor_values
    assert_equal '2019', d8.to_s
    assert_equal ['2019-01-01 00:00:00', '2020-01-01 00:00:00'], d8.__test_range_value
    assert_equal Time.new(2019, 7, 2, 12, 0), d8.midpoint_datetime
    ...
    assert_equal ['2011-10-19 00:00:00', '2011-10-24 00:00:00'], d10.__test_range_value
    assert_equal Time.new(2011, 10, 21, 12, 0), d10.midpoint_datetime
    ...
    assert_equal ['2011-10-08 00:00:00', '2011-10-11 00:00:00'], d11.__test_range_value
    assert_equal Time.new(2011, 10, 9, 12, 0), d11.midpoint_datetime
    ...
    assert_equal ['2011-10-08 07:00:00', '2011-10-08 07:00:00'], d12.__test_range_value # not extended by precision time unit
    assert_equal Time.new(2011, 10, 8, 7, 0), d12.midpoint_datetime # midpoint is between non-extended end points
    ...
    assert_equal ['2065-04-02 01:00:00', '2065-04-02 04:00:00'], d13.__test_range_value # not extended by precision time unit
    ...
    assert_equal ['2065-04-02 01:02:00', '2065-04-02 04:09:00'], d14.__test_range_value # not extended by precision time unit

    # Check range roll-over
    d20 = KDateTime.new("2011 10 17 23 59")
    assert_equal ['2011-10-17 23:59:00', '2011-10-18 00:00:00'], d20.__test_range_value
    assert_equal Time.new(2011, 10, 17, 23, 59, 30), d20.midpoint_datetime
    ...
    assert_equal '2011-11-23 18:40:00 UTC', d30.start_datetime.to_s # includes check it has +00:00 timezone
    assert_equal '2011-11-23 18:40:30 UTC', d30.midpoint_datetime.to_s
    assert_equal ['2011-11-23 18:40:00', '2011-11-23 18:41:00'], d30.__test_range_value
  ...
  def test_datetime_not_allowed
    e = assert_raises(RuntimeError) { KDateTime.new(DateTime.new(2019,10,4,2,4)) }
    assert_equal 'DateTime not supported by KDateTime', e.message
  end
