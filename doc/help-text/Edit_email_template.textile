...
By default, the colours used in the email are chosen from the colours used for the PRODUCT_NAME sytem.
...
* _From (email address)_: the 'from' address on the sent emails (the default is the administrator of your PRODUCT_NAME). Set this to a valid address for the responsible individual in your organisation.
