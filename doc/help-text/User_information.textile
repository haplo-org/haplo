...
* _API keys_: When other software communicates with the server, it uses an API key to authenticate instead of a username and password. This section lists all the current keys.
