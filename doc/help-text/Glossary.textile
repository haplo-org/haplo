...
*Pop-up*: a new window automatically opening in a web browser, you will need pop-ups enabled to use some of the features in PRODUCT_NAME, instructions for enabling pop-ups are different for each web browser.
...
*Search illustrator*: a feature in PRODUCT_NAME which displays an illustration of how your search terms will be connected together.
...
*Tray*: a holding place within PRODUCT_NAME into which you can add items which you use later.
