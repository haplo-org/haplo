...
However, aliased attributes do more than just changing the name. You can use them to change the kind of data the field contains. This can be useful when configuring PRODUCT_NAME to work with a standardised schema.
