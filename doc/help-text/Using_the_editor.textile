...
The editor is used to add or update all items in PRODUCT_NAME.
...
The pale yellow fields are lookup fields. Start typing your entry and matching choices will appear below the lookup field. Choose your entry from the list displayed. If your entry is not already in PRODUCT_NAME, choose _Create new..._ at the bottom of the list and fill in the details.
