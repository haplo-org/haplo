        ...
        ref: function(fieldName, nullNotAllowed) {
            return function(value) {
                if(value === null) { if(nullNotAllowed) { throw new Error(fieldName+" cannot be null");} }
                    ...
                    if(value instanceof $StoredObjectInterface) { value = value.ref; } // Allow objects to be used as well as just refs
...
$DbObject.$makeFactoryFunction = function(tableDefinition, fields, methods) {
    ...
    // Are there are some user defined methods to add to the row objects?
    if(methods !== null && methods !== undefined) {
        _.extend(DbObject.prototype, methods);
    }
