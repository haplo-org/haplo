    ...
    _pushRenderedHTML: function(instance, renderForm, context, nameSuffix, validationFailure, output) {
        ...
        if(renderForm) {
            if(this._checkboxStyle) {
                ...
                output.push(
                    '>',
                        '<label class="radio"><input type="radio" name="', this.name, nameSuffix, '" value="t"', ((value === true) ? ' checked' : ''),  '>', escapeHTML(trueLabel),  '</label>',
                        '<label class="radio"><input type="radio" name="', this.name, nameSuffix, '" value="f"', ((value === false) ? ' checked' : ''), '>', escapeHTML(falseLabel), '</label>',
                    '</span>'
                );
            }
        } else {
