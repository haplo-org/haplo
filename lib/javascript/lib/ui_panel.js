...
(function() {
    ...
    PanelBuilder.prototype = {
        ...
        status: function(priority, text) {
            // Translate "Status" into current locale.
            // Ideally this wouldn't be here, but legacy code embedded English text
            // -- don't copy this for any further action panel UI.
            let localeId = $host.i18n_getCurrentLocaleId();
            let textStatus = $i18n_platform_text[localeId]["JS_ACTION_PANEL_STATUS"] ||
                             $i18n_platform_text[$i18n_platform_text.DEFAULT]["JS_ACTION_PANEL_STATUS"];
            this._pushElement(priority, {title:textStatus, label:text});
            return this;
        },
