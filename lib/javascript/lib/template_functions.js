...
(function() {
    ...
    var FILE_ALLOWED_OPTIONS = {
        ...
        'authenticationSignatureValidForSeconds': 14400,   // use same name, but always use 4 hours as the validity time
        'forceDownload': true
    };
    ...
    O.$templateFunction = {
        ...
        "std:ui:request": function(message) {
            return $registry.standardTemplates["std:ui:request"]({
                message: message
            });
        },
        ...
        "std:resource:_plugin_document_edit_control_support": function() {
            $host.renderRTemplate("_client_side_resource", "plugin_document_edit_control_support");
            return '';
        },
