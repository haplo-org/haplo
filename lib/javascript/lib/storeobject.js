...
// -----------------------------------------------------------------------------------------------------------
//    $StoreObject - base class for all store objects, proxying KObject
// -----------------------------------------------------------------------------------------------------------

var $StoreObject = function() { };

_.extend($StoreObject.prototype, {
...
$StoreObject.prototype.__defineGetter__("title", function() {
    return this.firstTitle().toString();
});
$StoreObject.prototype.__defineGetter__("descriptiveTitle", function() {
    return this.$kobject.descriptiveTitle();
});
$StoreObject.prototype.__defineGetter__("labels", function() {
    return this.$kobject.getLabels();
});
$StoreObject.prototype.__defineGetter__("deleted", function() {
    return this.$kobject.getIsDeleted();
});
$StoreObject.prototype.__defineSetter__("labels", function(labels) {
    throw new Error("labels is a read only property");
});
$StoreObject.prototype.__defineGetter__("version", function() {
    return this.$kobject.getVersion();
});
$StoreObject.prototype.__defineGetter__("creationUid", function() {
    return this.$kobject.getCreatedByUid();
});
$StoreObject.prototype.__defineGetter__("lastModificationUid", function() {
    return this.$kobject.getLastModificationUid();
});
$StoreObject.prototype.__defineGetter__("creationDate", function() {
    return this.$kobject.getCreationDate();
});
$StoreObject.prototype.__defineGetter__("lastModificationDate", function() {
    return this.$kobject.getLastModificationDate();
});
$StoreObject.prototype.__defineGetter__("history", function() {
...
$StoreObject.prototype.each = $StoreObject.prototype.every;

// -----------------------------------------------------------------------------------------------------------
//    $StoreObjectMutable - add methods to modify a store object
// -----------------------------------------------------------------------------------------------------------

var $StoreObjectMutable = function() {};
$StoreObjectMutable.prototype = new $StoreObject();
_.extend($StoreObjectMutable.prototype, {
