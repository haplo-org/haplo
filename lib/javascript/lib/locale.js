...
$Locale.prototype.__defineGetter__("name", function() {
    return $i18n_locale_info[this.id].name;
});

$Locale.prototype.__defineGetter__("nameInLanguage", function() {
    return $i18n_locale_info[this.id].nameInLanguage;
});
...
$Locale.__i18nGetTranslationInPlatformTextForCurrentLocale = function(symbol) {
    ...
    return  $i18n_platform_text[localeId][symbol] ||
            $i18n_platform_text[$i18n_defaults.locale_id][symbol] ||
            symbol;
};
