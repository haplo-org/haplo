...
(function() {
    ...
    HTTPClient.prototype.bodyParameter = function(k,v) {
        this.$ensureMutable();
        this.$requestSettings["bodyParam:"+(Object.keys(this.$requestSettings).length)+":"+k.toString()] = v.toString();
        return this;
    };
    ...
    HTTPClient.prototype.queryParameter = function(k,v) {
        this.$ensureMutable();
        this.$requestSettings["queryParam:"+(Object.keys(this.$requestSettings).length)+":"+k.toString()] = v.toString();
        return this;
    };
