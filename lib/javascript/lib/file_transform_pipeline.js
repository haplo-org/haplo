...
(function() {
    ...
    _.extend(Pipeline.prototype, {
        ...
        urlForOutputWaitThenDownload: function(name, filename, view) {
    ...
    // TODO: Remove this compatibility for a mispelling of an API in a future API version
    Pipeline.prototype.urlForOuputWaitThenDownload = Pipeline.prototype.urlForOutputWaitThenDownload;
